...
(Launch Cursor in `/tmp/rufio-cross-harness-2026-05-21-run3` first, OR `cd` to it as your first command.)
...
```bash
cd /tmp/rufio-cross-harness-2026-05-21-run3
...
rufio recall --topics=v1-2-roadmap,rufio-open-impl
```
...
Keep a running diary at `~/rufio-cross-harness-2026-05-21-run3/diary-cursor.md`. Note every moment Rufio intrudes on your thinking, tagged:
...
- Stay in `/tmp/rufio-cross-harness-2026-05-21-run3`.

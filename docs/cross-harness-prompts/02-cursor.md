...
(Launch Cursor in `/tmp/rufio-cross-harness-2026-05-21` first, OR `cd` to it as your first command.)
...
Keep a running diary at `~/rufio-cross-harness-2026-05-21/diary-cursor.md`. Note every moment Rufio intrudes on your thinking, tagged:

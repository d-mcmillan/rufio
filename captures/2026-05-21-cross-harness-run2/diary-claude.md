...
- T+0 · NOTICED · REDUCIBLE — `rufio --version` printed `Shell cwd was reset to $HOME`. Every Bash call has that trailing line. Tiny, harmless, but every glance at output costs ~0.3s noise filtering. (Harness artifact, not rufio per se.)
